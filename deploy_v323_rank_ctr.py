...
# train parameters
job_conf = "jsonfile/yyj_exp_pdd_damodel_v323_rank_ctr.json"
if mode == 'predict':
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v4_predict.json"
elif mode == "vec":
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v511_vec.json"

work_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v323_rank_ctr_workspace/'
log_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v323_rank_ctr_workspace/'
set_xml_value(tony_et, "tony.worker.instances", "512")
set_xml_value(tony_et, "tony.ps.instances", "24")
if mode == 'predict':
...
#set_xml_value(tony_et, "tony.ps.memory", "60000m")
