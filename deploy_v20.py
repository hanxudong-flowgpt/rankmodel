...
# train parameters
job_conf = "jsonfile/yyj_exp_pdd_damodel_v2.json"
...
work_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/lsc_v2_workspace/ckpt/'
log_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/lsc_v2_workspace/ckpt/'
