...
src_dir = "./codes/"
main_script = "./codes/bootstrap/SeqPointCorunRankBS.py"
conf_file = "./xmlfile/tony_pmlimage_12p120w.xml"
...
# train parameters
job_conf = "jsonfile/yyj_exp_pdd_damodel_v433_rank_ctr.json"
if mode == 'predict':
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v4_predict.json"
elif mode == "vec":
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v4_vec.json"

work_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v433_rank_ctr_workspace/'
log_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v433_rank_ctr_workspace/'
if mode == 'predict':
