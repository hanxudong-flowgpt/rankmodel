...
# train parameters
job_conf = "jsonfile/yyj_exp_pdd_ltr_v1.json" if mode == 'train' else "jsonfile/yyj_exp_pdd_ltr_v1_predict.json"


work_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/ltr_ckpt/mainse/ltr_offline_v0_workspace/'
log_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/ltr_ckpt/mainse/ltr_offline_v0_workspace/'
...
if __name__ == "__main__":
    _, logf = submit_job('2019-12-5/hr=23')
