...
fg_conf_list = json.load(open('../jsonfile/pdd_damodel_conf_v51.json'))["features"]
fg_conf = {}
...
for tagxxx in open('fgv51.schema'):
...
json.dump({"features": features}, open('featurev51.json', 'w'))