...
# train parameters
job_conf = "jsonfile/yyj_exp_pdd_damodel_v432_ctvr_model2.json"
if mode == 'predict':
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v432_ctvr_model2.json"
elif mode == "vec":
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v432_model2_vec.json"

work_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v432_ctvr_model2_workspace/'
log_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v432_ctvr_model2_workspace/'
if mode == 'predict':
