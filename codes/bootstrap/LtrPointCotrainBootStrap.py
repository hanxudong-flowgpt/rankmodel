...
import numpy as np
from model.normal.ltr_cxr_model import KonduModel as Model
    ...
    def buildGraph(self, task_id, context):
        ...
        for modelconf in jobconf["sources"]:
            ...
            if self.train_config.shard:
                ...
                itera = build_hdfs_inputs_iterator(file_list, self.train_config.task_id - 1 if self.train_config.task_id > 0 else 0,
