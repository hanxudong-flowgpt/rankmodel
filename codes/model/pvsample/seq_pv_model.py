...
from model.pvsample.pvmodel import PvCxrModel
from model.ops import base_ops
from model.ops import attention
from model.ops import utils


class SeqAttenModel(PvCxrModel):
    def __init__(self,
                 train_config,
                 model_config,
                 model_columns,
                 model_name="CTR", model_idx=0, item_num_in_pv=10):
        super(SeqAttenModel, self).__init__(train_config, model_config, model_columns, model_name, model_idx, item_num_in_pv)
