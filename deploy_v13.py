...
conf_file = "./xmlfile/tony_damodel_v13.xml"
# day update
...
# train parameters
job_conf = "jsonfile/yyj_exp_pdd_damodel_v13.json"
...
work_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v13_workspace/'
log_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v13_workspace/'
...
commond = ["sh",
           "/data/common/barathrum/1.0.23/start-tony.sh",
