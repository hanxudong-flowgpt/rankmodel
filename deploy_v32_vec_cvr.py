...
src_dir = "./codes/"
main_script = "./codes/bootstrap/SeqPointVecRecallBS.py"
conf_file = "./xmlfile/tony_pmlimage.xml"
...
# train parameters
job_conf = "jsonfile/yyj_exp_pdd_damodel_v32_cvr.json"
if mode == 'predict':
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v32_predict.json"
elif mode == "vec":
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v32_vec.json"
...
work_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v32_cvr_workspace/'
log_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v32_cvr_workspace/'
