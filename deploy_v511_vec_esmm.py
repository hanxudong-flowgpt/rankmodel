...
# train parameters
job_conf = "jsonfile/yyj_exp_pdd_damodel_v511_esmm.json"
if mode == 'predict':
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v4_predict.json"
elif mode == "vec":
    job_conf = "jsonfile/yyj_exp_pdd_damodel_v511_vec.json"

work_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v511_esmm_workspace/'
log_space = 'hdfs://hq3-data-ns/user/search/rank_data/yangyouji/inet_ckpt/mainse/damodel_v511_esmm_workspace/'
if mode == 'predict':
